...
#ifndef RIDE_RIGHT_SUB_HSM_H  // <- This should be changed to your own guard on both
#define RIDE_RIGHT_SUB_HSM_H  //    of these lines
...
/**
 * @Function InitRideRightSubHSM(void)
