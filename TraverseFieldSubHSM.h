...
#ifndef TRAVERSE_FIELD_SUB_HSM_H  // <- This should be changed to your own guard on both
#define TRAVERSE_FIELD_SUB_HSM_H  //    of these lines
...
/**
 * @Function InitTraverseFieldSubHSM(void)
...
#endif /* TRAVERSE_FIELD_SUB_HSM_H */
