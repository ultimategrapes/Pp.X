...
typedef enum {
    ...
    RIGHT_BORDER_FOUND,
    LEFT_BORDER_FOUND,
    LEFT_OBSTACLE_CLEARED,
    RIGHT_OBSTACLE_CLEARED,
    BEACON_DETECTED,
    BEACON_NOT_DETECTED,
    ISZ_FOUND,
    OBSTACLE_DETECTED,
...
#define EVENT_CHECK_HEADER "AllEventChecker.h"

/****************************************************************************/
// This is the list of event checking functions
#define EVENT_CHECK_LIST  CheckBattery, CheckTape, CheckSwitch, CheckBeacon
...
#define TURNRIGHT_TIMER 0
#define BACKWARD_TIMER 1
#define FORWARD_TIMER 2
#define TURNLEFT_TIMER 3
#define REV_TIMER 4
#define SAMPLE_TIMER 5
